...
The default for the content pages presents the information and data in a useful way and makes use of the images, which are connected to the item displayed.\\
To conform with the technical specifications the extension is required to be responsive and work on mobile devices. \\
\\
