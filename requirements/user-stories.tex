...
From the following scenarios user stories could be identified. The user stories follow the style of the Connextra development team (\textit{Connextra format}), which is %\todo{quote: http://www.strongandagile.co.uk/index.php/what-makes-a-good-user-story/}
\begin{quote}
