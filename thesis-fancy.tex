...
This thesis gives an introduction on the fundamentals of the project and includes the requirement analyses done in order to implement the features needed in order to achieve the goal of providing more information for under-resourced languages.
