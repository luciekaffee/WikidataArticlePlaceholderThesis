...
The mayor objective of this thesis is to increase the access to open and free knowledge in Wikipedia by developing a MediaWiki extension called \textit{ArticlePlaceholder}. \\
\\
ArticlePlaceholders are auto-generated content pages in Wikipedia from information provided by Wikidata. \\
The criterias for the extension were developed with a requirement analysis and the implemented. \\
This thesis gives an introduction to the fundamentals of the project and includes the requirement analysis done in order to implement the needed features to achieve the goal of providing more information for under-resourced languages.
