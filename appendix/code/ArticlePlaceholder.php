...
$wgAutoloadClasses['ArticlePlaceholder\PropertyOrderProvider']
	= __DIR__ . '/includes/PropertyOrderProvider.php';
$wgAutoloadClasses['ArticlePlaceholder\ArticlePlaceholderServices']
	= __DIR__ . '/includes/ArticlePlaceholderServices.php';
$wgAutoloadClasses['ArticlePlaceholder\ArticlePlaceholderException']
	= __DIR__ . '/includes/Exception/ArticlePlaceholderException.php';
...
$wgResourceModules['ext.articleplaceholder.defaultDisplay'] = array(
	'styles' => array(
		...
		'ext.articleplaceholder.defaultDisplaySmall.css' => array( 'media' => '(max-width: 930px)' ),
	),
	'position' => 'top',
) + $commonModuleInfo;
