...
\includepdf[pages=2, scale=0.8, pagecommand={\let\thefootnote\relax\footnote{\citep{wiki:36}}}, link, linkname=odwikipdf]{appendix/odwiki-discussion}
...
\includepdf[pages=4, scale=0.8, pagecommand={\let\thefootnote\relax\footnote{\citep{wiki:35}}}, link, linkname=eswikipdf]{appendix/eowiki-discussion}
