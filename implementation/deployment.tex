...
To deploy an extension to the Wikimedia cluster, it is necessary to pass a security review by a Security Engineer of the Wikimedia Foundation. \todo{in order to?}
