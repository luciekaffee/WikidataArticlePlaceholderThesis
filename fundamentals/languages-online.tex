...
The conclusion can be drawn that there are a few languages that are very well resourced, while a vast majority of speakers of other languages do not have access to much information in their native language. \todo{Quote that this one of the major problems for access}